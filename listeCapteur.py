...
def removeCapteur(batiment, salle, typeCapteur, name, liste):
     if capteurExists(batiment, salle, typeCapteur, name, liste)
          liste[batiment][salle][typeCapteur].del(name)
          return 0
     return 1
